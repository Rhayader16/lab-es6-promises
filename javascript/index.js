...
// Bonus 2 - Promise all
// ...
const allInstructions = Promise.all(
  brusselsSprouts.map((el, i) => obtainInstruction("brusselsSprouts", i))
);

allInstructions
  .then((everyInstruction) => {
    console.log(everyInstruction);
    everyInstruction.forEach((el, i) => {
